package org.example.item03_SingletonPattern;
// ============================================================================
...
public class SingletonPatterns_ {
    ...
    public static class SerializableSingleton_BestPractice4 implements Serializable {
        ...
        private transient String configValue = "default";  // transient برای state
    ...
    public static void demonstrateEnumSafety() {
        ...
        // Reflection Attack on Enum
        try {
            // Enum constructors have signature: (String name, int ordinal)
            ...
            System.out.println("✅ Reflection blocked: Cannot reflectively create enum objects");
        } catch (Exception e) {
        ...
        // Enum.clone() is protected (inherited from java.lang.Object via java.lang.Enum)
        // and even if accessible, it always throws CloneNotSupportedException
        // We demonstrate this with reflection to bypass protected access
        try {
            java.lang.reflect.Method cloneMethod = 
                java.lang.Enum.class.getDeclaredMethod("clone");
            cloneMethod.setAccessible(true);
            cloneMethod.invoke(AppConfig_BestPractice1.INSTANCE);
        } catch (java.lang.reflect.InvocationTargetException e) {
            if (e.getCause() instanceof CloneNotSupportedException) {
                System.out.println("✅ Enum clone blocked: " + e.getCause().getMessage());
            }
        } catch (NoSuchMethodException e) {
            System.out.println("✅ Enum clone method is protected and final");
        } catch (Exception e) {
            System.out.println("✅ Enum clone blocked: " + e.getClass().getSimpleName());
        }
    }
